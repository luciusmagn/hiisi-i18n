...
(:auth-institution-stage-title . "Institucionální přístup")
(:auth-institution-stage-subtitle . "Použijte školní nebo univerzitní e-mail. Oprávněné účty se po ověření e-mailu odemknou přes instituci.")
(:auth-institution-title . "Registrace přes vaši instituci")
(:auth-institution-subtitle . "Použijte školní nebo univerzitní e-mail. Pokud je vaše instituce v Hiisi nastavená, účet se po ověření e-mailu odemkne přes ni; individuální 14denní zkušební období patří k registraci s osobním plánem.")
(:auth-institution-benefit-email . "Použijte školní nebo univerzitní e-mailovou adresu.")
(:auth-institution-benefit-access . "Oprávněné účty získají institucionální přístup po ověření e-mailu.")
(:auth-institution-benefit-fallback . "Pokud doménu nerozpoznáme, vyberte osobní plán nebo požádejte instituci, aby Hiisi kontaktovala.")
(:auth-see-included . "Co je zahrnuto")
(:auth-institution-check-access . "Ověřit přístup")
(:auth-institution-email-eligible-title . "Institucionální přístup potvrzen")
(:auth-institution-email-eligible-detail . "Pokračujte s tímto e-mailem a vytvořte si účet. Přístup se odemkne po ověření e-mailu.")
(:auth-institution-change-email . "Použít jiný e-mail")
(:auth-institution-outcome-note . "Pokud vaše škola nebo univerzita poskytuje přístup k Hiisi, účet se po ověření e-mailu odemkne. Pokud doména není oprávněná, vyberte osobní plán a spusťte 14denní zkušební období.")
(:auth-institution-personal-plan-link . "Zobrazit osobní plány")
(:auth-institution-domain-unrecognized . "Tuto institucionální e-mailovou doménu zatím neznáme. Vyberte osobní plán a spusťte 14denní zkušební období, nebo požádejte svou instituci, aby Hiisi kontaktovala.")
...
(:auth-new-password-same . "Nové heslo se musí lišit od současného hesla.")
 ...
 (:translate-saved-to-my-cards . "Uloženo do Moje kartičky")
 (:translate-saved-to-deck . "Uloženo do ~A")
 (:translate-view-my-cards . "Zobrazit Moje kartičky")
 (:translate-new-deck . "Vytvořit nový balíček")
 (:translate-add-to-deck . "Přidat do balíčku")
 (:translate-feedback-label . "Zpětná vazba ke kvalitě")
 (:translate-feedback-helpful . "Užitečné")
 (:translate-feedback-helpful-marked . "Označeno jako užitečné")
 (:translate-regenerate-translation . "Vygenerovat překlad znovu")
 (:translate-regenerate-confirm . "Hiisi označí tento výsledek jako nepřesný a vygeneruje nový překlad. Pokračovat?")
 ...
 (:dashboard-welcome-title . "Přeložte svůj první text")
 (:dashboard-welcome-subtitle . "Přeložte užitečnou frázi, uložte si ji do balíčku a zopakujte si ji, až to bude potřeba.")
 ...
 (:dashboard-first-use-checklist-title . "První kroky")
 (:dashboard-first-use-checklist-translate . "Vytvořte svůj první překlad")
 (:dashboard-first-use-checklist-card . "Uložte svou první kartičku")
 (:dashboard-first-use-checklist-review . "Dokončete své první opakování")
 ...
 (:subscribe-founder-monthly-equivalent . "€6,58/měsíc, účtováno ročně")
 (:subscribe-founder-savings . "Ušetříte €41 ročně oproti měsíční platbě")
 (:subscribe-monthly-billing-equivalent . "€10/měsíc, účtováno měsíčně")
 (:subscribe-monthly-billing-note . "Flexibilní měsíční platba")
 (:landing-pricing-comparison-title . "Rychlé srovnání")
...
(:review-session-expired . "Vaše opakovací relace vypršela. Začněte prosím novou relaci.")
 ...
 (:privacy-third-clankermails-val . "Pro odesílání aktivačních e-mailů a transakčních zpráv.")
 ...
 (:decks-add-from-flashcards-title . "Přidat kartičky")
 (:decks-add-from-flashcards-info . "Vyberte kartičku a přidejte její překlad do tohoto balíčku.")
 (:decks-create-new-flashcard . "Vytvořit novou kartičku")
 (:decks-open-flashcards . "Přidat existující kartičky")
 ...
 (:landing-credibility-languages . "Patnáct jazyků")
 (:landing-credibility-flashcards . "Chytré kartičky")
 (:landing-credibility-pronunciation . "Průvodce výslovností")
 (:landing-languages-title . "Vyberte si jazyk, který se už dlouho chystáte učit")
 (:landing-video-title . "Stiskněte přehrát a pořádně se seznamte s Hiisi")
 (:landing-video-placeholder-label . "Zástupné místo pro produktové video Hiisi")
 (:landing-video-placeholder-eyebrow . "Produktové video")
 (:landing-video-placeholder-copy . "Krátké produktové video zde ukáže práci se záložkami, gramatikou, výslovností a opakováním.")
 (:landing-problem-title . "Věta, kterou jste přeložili minulý týden. Řeknete ji teď?")
 (:landing-problem-body-1 . "Ten okamžik se stává často. Uvidíte frázi. Vložíte ji do překladače. Význam v tu chvíli dává smysl přímo ve vaší ruce. Uplyne týden. Znění zmizelo z paměti a význam s ním.")
 (:landing-problem-body-2 . "Překlad udrží význam pro chvíli, kdy ho čtete. Ale naučit se větu obvykle vyžaduje čtyři samostatné nástroje:")
 (:landing-problem-tool-1 . "Překladač pro význam")
 (:landing-problem-tool-2 . "Gramatickou příručku pro strukturu")
 (:landing-problem-tool-3 . "Průvodce výslovností pro zvuk")
 (:landing-problem-tool-4 . "Aplikaci s kartičkami pro udržení v paměti")
 (:landing-problem-body-3 . "Používání všech čtyř nástrojů zabere čas. A další věta je pryč dřív, než dokončíte kartičku.")
 (:landing-bookmark-title . "Co se stane, když si v Hiisi uložíte větu")
 (:landing-bookmark-body . "Jedno klepnutí. Hiisi z věty během několika sekund udělá strukturovaný studijní prvek připravený k učení. Věta zůstane ve vaší knihovně s překladem a gramatikou.")
 (:landing-bookmark-benefit-1 . "Původní větu a jasný překlad")
 (:landing-bookmark-benefit-2 . "Výslovnost v Mezinárodní fonetické abecedě, IPA")
 (:landing-bookmark-benefit-3 . "Gramatiku vysvětlenou v jazyce, ve kterém chcete vysvětlení číst")
 (:landing-bookmark-benefit-4 . "Barevně spárovaná slova ukazují, která část překladu patří ke kterému originálu")
 (:landing-bookmark-benefit-5 . "Kartičku, která se vrátí, když ji vaše paměť potřebuje")
 (:landing-bookmark-cta . "Uložit první větu")
 (:landing-use-cases-title . "Na co můžete Hiisi použít")
 (:landing-use-cases-body . "K začátku stačí jedna věta. S Hiisi funguje cokoli, co v novém jazyce čtete nebo slyšíte.")
 (:landing-use-case-lyrics . "Texty písní, které si pouštíte pořád dokola")
 (:landing-use-case-articles . "Články v jazyce, který se učíte")
 (:landing-use-case-messages . "Zprávy od přátel, kteří jsou rodilí mluvčí")
 (:landing-use-case-media . "Věty z filmů nebo podcastů, které si uložíte")
 (:landing-use-case-current-page . "Stránka, kterou právě čtete")
 (:landing-benefits-title . "Pro samouky i studenty")
 (:landing-benefit-grammar-title . "Gramatika v jazyce, ve kterém už přemýšlíte")
 (:landing-benefit-grammar-body . "Čtěte francouzskou gramatiku česky nebo španělskou gramatiku polsky. Pozornost zůstává u věty, kterou se učíte.")
 (:landing-benefit-colour-title . "Slova spárovaná barvou")
 (:landing-benefit-colour-body . "Slovo a jeho překlad sdílejí stejnou barvu. Význam každého slova vidíte na první pohled.")
 (:landing-benefit-pronunciation-title . "Výslovnost, kterou můžete číst")
 (:landing-benefit-pronunciation-body . "Každá věta má psaného průvodce výslovností, podobného tomu ve slovnících. Vidíte, jak věta zní, než ji vyslovíte.")
 (:landing-benefit-schedule-title . "Kartičky, které se plánují samy")
 (:landing-benefit-schedule-body . "Každá uložená věta se stane kartičkou. Algoritmus SM-2 za Anki rozhodne, kdy se vrátí, takže opakujete to, co se chystáte zapomenout.")
 (:landing-benefit-decks-title . "Tematické balíčky pro to, co vás čeká")
 (:landing-benefit-decks-body . "Cestujete příští měsíc? Nastupujete do nové práce? Importujte hotový balíček pro restaurace nebo pohovory a opakujte od prvního dne.")
 (:landing-benefit-languages-title . "Patnáct jazyků, libovolný směr")
 (:landing-benefit-languages-body . "Překládejte ze španělštiny do francouzštiny nebo z angličtiny do němčiny. Hiisi zvládá každý směr v celé sadě.")
 (:landing-benefits-cta . "Vyzkoušet Hiisi")
 (:landing-inside-title . "Jak vypadá učení v Hiisi")
 (:landing-inside-body . "Otevřete Hiisi. Kartičky na dnešek čekají, každá z nich je věta, kterou jste si uložili, s připojeným překladem a gramatikou. Vidíte novou větu, kterou si chcete nechat? Uložte si ji. Dostane se do zítřejší hromádky k opakování.")
 (:landing-inside-flow-due . "Kartičky na dnešek")
 (:landing-inside-flow-bookmark . "Uložit novou větu")
 (:landing-inside-flow-review . "Zítřejší opakování")
 (:landing-audience-title . "Pro koho je Hiisi")
 (:landing-audience-body . "Už se vám ztratila užitečná věta? Hiisi je pro vás.")
 (:landing-audience-beginners . "Začátečníci, kteří si skládají první fráze v novém jazyce")
 (:landing-audience-intermediate . "Středně pokročilí, kteří umějí číst, ale narážejí na gramatiku")
 (:landing-audience-heritage . "Lidé, kteří se doma znovu vracejí k rodnému jazyku")
 (:landing-audience-travellers . "Cestovatelé a partneři rodilých mluvčích, kteří chtějí věty, které opravdu použijí")
 (:landing-audience-beginners-label . "Začátečníci")
 (:landing-audience-beginners-detail . "Skládají si první fráze v novém jazyce")
 (:landing-audience-intermediate-label . "Středně pokročilí")
 (:landing-audience-intermediate-detail . "Umějí číst, ale narážejí na gramatiku")
 (:landing-audience-heritage-label . "Rodilí mluvčí")
 (:landing-audience-heritage-detail . "Vracejí se doma k rodnému jazyku")
 (:landing-audience-travellers-label . "Cestovatelé a partneři")
 (:landing-audience-travellers-detail . "Věty, které opravdu použijí")
