...
(:review-session-expired . "Vaše opakovací relace vypršela. Začněte prosím novou relaci.")
 ...
 (:landing-problem-title . "Věta, kterou jste si přeložili minulý týden. Řeknete ji teď?")
 (:landing-problem-body . "Ten okamžik se opakuje pořád. Uvidíte frázi, vložíte ji do překladače a význam dává smysl přímo v ruce. Uplyne týden; znění vám z paměti zmizelo a význam s ním. Naučit se jednu větu obvykle vyžaduje čtyři různé nástroje:")
 (:landing-tool-translator . "Překladač na význam")
 (:landing-tool-grammar . "Gramatickou příručku na stavbu věty")
 (:landing-tool-pronunciation . "Průvodce výslovností na zvuk")
 (:landing-tool-flashcards . "Aplikaci s kartičkami na zapamatování")
 (:landing-problem-outro . "Používat všechny čtyři zabere čas a další věta je pryč dřív, než dokončíte kartičku.")
 (:landing-bookmark-title . "Co se stane, když si větu založíte")
 (:landing-bookmark-intro . "Jedno klepnutí a Hiisi během pár sekund promění větu ve strukturovanou učební položku. Zůstane ve vaší knihovně se vším, co k ní patří:")
 (:landing-bookmark-item-translation . "Původní věta a srozumitelný překlad")
 (:landing-bookmark-item-pronunciation . "Výslovnost zapsaná tak, jak to dělají slovníky")
 (:landing-bookmark-item-grammar . "Gramatika vysvětlená v jazyce, ve kterém čtete nejraději")
 (:landing-bookmark-item-colors . "Barevně spárovaná slova ukazují, která část patří ke které")
 (:landing-bookmark-item-flashcard . "Kartička, která se vrátí, když ji vaše paměť potřebuje")
 (:landing-bookmark-cta . "Založte si první větu")
 (:landing-sources-title . "Na začátek stačí jedna věta")
 (:landing-sources-intro . "S Hiisi funguje cokoli, co v novém jazyce čtete nebo slyšíte:")
 (:landing-source-lyrics . "Text písně, kterou si pořád pouštíte")
 (:landing-source-articles . "Články v jazyce, který se učíte")
 (:landing-source-messages . "Zprávy od rodilých mluvčích")
 (:landing-source-films . "Repliky z filmů nebo podcastů, které si ukládáte")
 (:landing-source-page . "Stránka, kterou právě čtete")
 (:landing-features-title . "Postaveno pro samouky i studenty")
 (:landing-feature-grammar-title . "Gramatika v jazyce, ve kterém přemýšlíte")
 (:landing-feature-grammar-body . "Čtěte francouzskou gramatiku česky nebo španělskou polsky. Vaše pozornost zůstává u věty, kterou se učíte.")
 (:landing-feature-colors-title . "Slova spárovaná barvou")
 (:landing-feature-colors-body . "Slovo a jeho překlad sdílejí stejnou barvu, takže význam každého slova vidíte na první pohled.")
 (:landing-feature-pronunciation-title . "Výslovnost, kterou si přečtete")
 (:landing-feature-pronunciation-body . "Každá věta přichází s psaným průvodcem výslovností, stejným, jaký používají slovníky. Vidíte, jak zní, dřív než ji vyslovíte.")
 (:landing-feature-flashcards-title . "Kartičky, které se plánují samy")
 (:landing-feature-flashcards-body . "Každá založená věta se stane kartičkou. Algoritmus SM-2, který stojí za Anki, rozhodne, kdy se vrátí, takže opakujete právě to, co byste zapomněli.")
 (:landing-feature-decks-title . "Tematické balíčky na to, co vás čeká")
 (:landing-feature-decks-body . "Cestujete příští měsíc? Nastupujete do nové práce? Naimportujte si hotový balíček a opakujte od prvního dne.")
 (:landing-feature-directions-title . "Patnáct jazyků, libovolný směr")
 (:landing-feature-directions-body . "Překládejte ze španělštiny do francouzštiny nebo z angličtiny do němčiny. Hiisi zvládá všechny směry v celé sadě.")
 (:landing-flow-title . "Jak vypadá učení v Hiisi")
 (:landing-flow-body . "Otevřete Hiisi. Kartičky na dnešek už čekají, každá je věta, kterou jste si uložili, i s překladem a gramatikou. Vidíte novou větu, kterou si chcete nechat? Založte si ji a zítra se objeví v opakování.")
 (:landing-who-title . "Pro koho Hiisi je")
 (:landing-who-intro . "Už se vám někdy ztratila užitečná věta? Hiisi vzniklo přesně pro vás.")
 (:landing-who-beginners . "Začátečníci, kteří skládají první fráze v novém jazyce")
 (:landing-who-intermediate . "Pokročilejší studenti, kteří čtou dobře, ale zakopávají o gramatiku")
 (:landing-who-native . "Rodilí mluvčí, kteří se vracejí k jazyku z domova")
 (:landing-who-travellers . "Cestovatelé a partneři rodilých mluvčích, kteří chtějí věty k použití")
